...
ifeq ($(OPLUS_FEATURE_OPPO_TARGET_DEVICE),MSM_18115)
export CONFIG_OPPO_TARGET_DEVICE=18115
KBUILD_CFLAGS += -DCONFIG_OPPO_TARGET_DEVICE
else ifeq ($(OPLUS_FEATURE_OPPO_TARGET_DEVICE),MSM_18501)
export CONFIG_OPPO_TARGET_DEVICE=18501
KBUILD_CFLAGS += -DCONFIG_OPPO_TARGET_DEVICE
else ifeq ($(OPLUS_FEATURE_OPPO_TARGET_DEVICE),MSM_19081)
export CONFIG_OPPO_TARGET_DEVICE=19081
KBUILD_CFLAGS += -DCONFIG_OPPO_TARGET_DEVICE
